...
fn main() {
    ...
    use cosmian_cover_crypt::api::{Covercrypt, EncryptedHeaderEnc};
    ...
    let encrypted_header =
        EncryptionHeaderAes256::deserialize(&transcoder.decode(HEADER.as_bytes()).unwrap())
            .unwrap();
    for _ in 0..1000 {
        EncryptionHeaderAes256::decrypt(&encrypted_header, &cc, &usk, None)
